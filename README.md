...
- Gaps are moves not mentioned in PGN that are sufficiently good/popular (choice function is complex and evolving).
- Move choice is based on engine evaluation, move score rate, chances to transpose, and presumed ease of memorization.
